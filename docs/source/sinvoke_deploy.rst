...
Invocar a máquina virtual que recupera el archivo particular de SSH de máquina base. En computación, el SSH File Transfer Protocol (también Secure File Transfer Protocol, o SFTP) es un protocolo de red que proporciona acceso a los archivos, transferencia de archivos y funciones de gestión de archivo sobre cualquier secuencia de datos fiables.

comando Ayuda
----------------

Este comando ayuda a determinar el uso de la invocación de módulo. El usuario llegará a saber acerca del manera/formato diferente para ejecutar este módulo.  Este comando guía al usuario final para conocer el propósito de este comando. A continuación dado son el comando y la captura de pantalla del mismo.
...
Cuando el usuario necesita recoger datos del servidor al sistema cliente usando cli, el siguiente comando obtendrá toda la información al abrir la cáscara,
...
Cuando el usuario necesita recoger datos del servidor al sistema cliente usando el script, el siguiente comando ejecutar cada línea de un archivo de script proporcionado del mando a distancia
...
Cuando el usuario necesita recoger datos del servidor al sistema cliente utilizando los datos, el siguiente comando ejecutar variable php en uno o más controles remotos.
...
* Este comando ayuda a Recupera archivos SSH o directorios
* Obtiene un archivo o directorio desde el origen al destino utilizando solo comando
