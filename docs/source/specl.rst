...
Cuando el usuario necesita instalar un pecl , el comando a continuación se indica se ejecutará el proceso.
...
Cuando el usuario necesita para asegurar una pecl , el siguiente comando dado se ejecutará el proceso.
...
El comando que se utiliza para actualizar el paquete pecl se muestra a continuación,
