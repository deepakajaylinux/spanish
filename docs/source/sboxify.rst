...
Esta módulos sobres las principales necesidades de los usuarios en la creación y así como la gestión de la caja. Este tema es discutir acerca de cómo utilizar este módulo, y sobre varias funciones en el uso de boxify.
...
La sintaxis para declarar el comando de ayuda no es sensible a mayúsculas, que es una ventaja añadida. La siguiente captura de pantalla a visualizar sobre el comando de ayuda bajo boxify.
...
Varias funciones de boxify
---------------------------------

Este tema describe acerca de las diversas funciones de boxify bajo este módulo, como se indica a continuación
...
* Todas las funciones principales de la gestión de una caja se envuelve bajo este único módulo.
