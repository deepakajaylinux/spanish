...
.. cssclass:: table-bordered
 ...
 +==========================+=========================================+==============+===========================================+
 |ptconfigure cassandra     | Hay dos parámetros alternativos que     | Y(Yes)       | El sistema se inicia proceso de           |
 |Install? (Y/N)            | pueden ser utilizados en la línea       |              | instalación                               |
 |                          | de comandos. Cassandra , cassandra      |              |                                           |
 |                          | Por ejemplo: ptconfigure cassandra      |              |                                           |
 |                          | install, ptconfigure Cassandra install  |              |                                           |
 +--------------------------+-----------------------------------------+--------------+-------------------------------------------+
 |ptconfigure cassandra     | Hay dos parámetros alternativos que     | N(No)        | El sistema detiene proceso de instalación |
