...
Zephir - Ze(nd Engine) Ph(p) I(nt)r(mediate) - es un lenguaje de alto nivel que facilita la creación y el mantenimiento de extensiones para PHP . Extensiones Zephir se exportan a código C que puede ser compilado y optimizado por los principales compiladores de C tales como gcc / sonido metálico / vc ++ . Funcionalidad se expone al lenguaje PHP . Zephir es un código abierto y permite a los desarrolladores de alto nivel hacen extensiones PHP bajo nivel .


Ayuda Comando
---------------

Este comando se describe el uso del módulo zephir . En él se enumeran los parámetros de zephir y la sintaxis para el funcionamiento del módulo zephir . la comando de ayuda para el módulo zephir se muestra a continuación ,
...
El comando utilizado para instalar el módulo zephir en el terminal aparece a continuación ,
...
* Zephir ofrece beneficios tanto compilado , así como lenguaje interpretado
* Seguridad Memoria
* Tanto tipado dinámico / estático, etc ..
